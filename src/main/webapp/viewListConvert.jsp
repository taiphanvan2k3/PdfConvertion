			...
			<table class="styled-table">
				...
				<tbody>
					...
					<tr class="active-row">
						...
						<td class="text-center"><%=upload.getFileUpload()%></td>
						<td class="text-center"><a
							href="./DownloadFileController?action=downloadfile&fileName=<%=upload.getFileConverted()%>"
							target="_blank"><%=upload.getFileConverted()%></a></td>
